...
<section className='ba'></section>
        ...
        <section className="section10">
            ...
            <div className="s10">
            <div className="div1">
                <div className="headlast"><h1 className="homeo" style={{color:"black"}}>Homeo</h1><h1 className="drug">Drug</h1></div>
           
            <p className="t2025">© 2025 HomeoDrug.com</p>
            <div className="social">
              <img  id="fb" src="https://1000logos.net/wp-content/uploads/2017/02/Facebook-Logosu.png" alt="" />
            <img id="tw" src="https://images.freeimages.com/image/large-previews/f35/x-twitter-logo-on-black-circle-5694247.png" alt="" />
            
            <img id="ig" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTg6k1Wb6YMIVdxnvh9VErbhOqmY5-USUFlwA&s" alt="" />
            </div>
            </div>
              ...
              <div className="div2">
                <span id="get"> FEATURES</span>
                
                <p>Texting</p>
            
                <p> Straight to Voice</p>
                <p>Voice message</p>
              </div>
              <div className="div3">
                <span id="get">LEARN MORE</span>
                <p>Blog</p>
                <p>Support</p>
                <br /><br />
            ...
            <h4 id="help"><Link to='/contact'>Help</Link></h4>
